...
describe('RegisterComponent', () => {
  ...
  describe('onSubmit()', () => {
    ...
    it('should NOT submit when OTP has not been sent', () => {
      component.registerForm.patchValue({ name: 'J', email: 'j@test.com', password: 'Test@1', role: 'JOB_SEEKER' });
    ...
    it('should include otpCode in register payload when all conditions met', fakeAsync(() => {
      component.registerForm.patchValue({ name: 'J', email: 'j@test.com', password: 'Test@123', role: 'JOB_SEEKER' });
      component.otpSent = true;
